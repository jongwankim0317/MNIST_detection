...
parser.add_argument('--model_num', type=int, default=1,  help="number of the model you want to measure among the models")
parser.add_argument('--no-animation', help="no animation is shown.", action="store_true")
parser.add_argument('--no-plot', help="no plot is shown.", action="store_true")
parser.add_argument('--quiet', help="minimalistic console output.", action="store_true")
# argparse receiving list of classes to be ignored (e.g., python main.py --ignore 1 3)
...
GT_PATH = '/home/jongwan0317/dataset/MNIST2020/MNIST2020_test/MNISTdevkit/MNIST2020/ground-truth'
pr_PATH = '/home/jongwan0317/dataset/MNIST2020/MNIST2020_test/MNISTdevkit/MNIST2020'
IMG_PATH ='/home/jongwan0317/dataset/detection_MNISTtest/MNISTdevkit/MNIST2020/PNGImages'
D_PATH = os.path.join(pr_PATH, "prediction_model{}".format(args.model_num))
DR_PATH = recent_file(D_PATH)
